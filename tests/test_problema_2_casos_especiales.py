...
class TestCasosEspeciales:
    ...
    def test_positivo_150_pct_plan_anual_tope_100(self):
        ...
        resultado = recalcular_cumplimiento_faltante(100, 150, sentido="Positivo", id_indicador="45")
    ...
    def test_tope_regular_130_pct(self):
        ...
        resultado = recalcular_cumplimiento_faltante(100, 200, sentido="Positivo", id_indicador="999")
