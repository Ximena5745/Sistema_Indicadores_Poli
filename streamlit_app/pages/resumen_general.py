...
st.set_page_config(
    page_title="Dashboard Estratégico - Sistema de Indicadores",
    page_icon="📊",
    layout="wide",
    initial_sidebar_state="expanded"
)

# Obtener ruta del dashboard HTML
...
<div style='text-align: center; margin-bottom: 2rem;'>
    <h1 style='color: #667EEA; font-size: 2.5rem; font-weight: 700; margin-bottom: 0.5rem;'>
...
# Cargar y mostrar el dashboard HTML
if DASHBOARD_HTML.exists():
    html_content = DASHBOARD_HTML.read_text(encoding='utf-8')
    
    # Mostrar el dashboard HTML completo
    st.components.v1.html(html_content, height=2800, scrolling=True)
else:
    st.error(f"""
    ### ❌ Dashboard no encontrado
    
    El archivo del dashboard no existe en la ruta esperada:
    `{DASHBOARD_HTML}`
    
    **Soluciones:**
    1. Verifica que el archivo `dashboard_estrategico.html` exista en la carpeta `streamlit_app`
...
<div style='text-align: center; color: #9CA3AF; font-size: 0.875rem; padding: 1rem;'>
    <p>📊 Dashboard Estratégico v2.0 | Actualizado: 2026 | 
    <span style='color: #667EEA;'>Sistema de Indicadores - Politécnico Grancolombiano</span></p>
</div>
""", unsafe_allow_html=True)
"""
pages/1_Resumen_General.py — Dashboard Estratégico y Operativo PDI & Procesos.
