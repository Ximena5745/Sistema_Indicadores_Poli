...
Uso CORRECTO (post-Problema #2):
  ...
  • Para categorización completa: from core.domain import categorizar_cumplimiento (✅ RUTA CANÓNICA)

Este archivo mantiene exports para compatibilidad heredada (será eliminado en próxima versión).
NOTA: Post-consolidación, categorizar_cumplimiento() está en core.domain (core.semantica se conserva como fachada legacy).
"""
